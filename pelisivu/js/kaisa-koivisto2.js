...
$("#calculate1").on("click", function() {
    ...
    if (problem1 === 77) {
        ...
        $("#final_result1").html(total_count + " / " + total_questions);
    } else {
...
$("#calculate2").on("click", function() {
    ...
    if (problem2 === 18) {
        ...
        $("#final_result2").html(total_count + " / " + total_questions);
...
$("#calculate3").on("click", function() {
    ...
    if (problem3 === 4) {
        ...
        $("#final_result3").html(total_count + " / " + total_questions);
    } else {
        total_questions = total_questions + 1;
...
$("#calculate4").on("click", function() {
    ...
    if (problem4 === 62) {
        ...
        $("#final_result4").html(total_count + " / " + total_questions);
    } else {
        total_questions = total_questions + 1;
...
$("#calculate5").on("click", function() {
    ...
    if (problem5 === 31) {
        ...
        $("#final_result5").html(total_count + " / " + total_questions);
    } else {
        total_questions = total_questions + 1;
    ...
    if (problem6 === 9) {
        ...
        $("#final_result6").html(total_count +  " / " + total_questions);
    } else {
        total_questions = total_questions + 1;
